...
An EPE is there to help you understand the material and succeed in the course. They will be leading in class assignments. hold special tutoring sessions, and support you in your R programming skills. These educators are trained with study skills that will set you up with success in college.
...
Participation is based on short writing assignments conducted in class. These assignments will be lead by the EPE in class. You will need to complete at least 20 prompts to get full credit for the semester. There will be no make ups for these writing prompts.
